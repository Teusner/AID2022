	...
	\part{Introduction}
		...
		\begin{frame}{Introduction}{Financing of the works}
			...
			\begin{minipage}{0.6\textwidth}
				\begin{block}{Research laboratories}
					\begin{itemize}
						\item ENSTA Bretagne
					\end{itemize}
				\end{block}
				...
				\begin{block}{Projects}
					\begin{itemize}
						\item \textbf{DGA RAPID PROTEUS} :\\ Underwater acoustic propagation simulation using Finite Difference Time Domain 
					...
					\begin{minipage}{0.45\textwidth}
						...
						\begin{figure}[!htb]
							...
							\resizebox{\textwidth}{!}{
								\begin{tikzpicture}
									\foreach \i in {-2,...,2} {
										\draw [ForestGreen] (\i,-2) -- (\i,2);
										\draw [RoyalBlue] (\i+0.5,-2.5) -- (\i+0.5,1.5);
									}
									\foreach \i in {-2,...,2} {
										\draw [ForestGreen] (-2,\i) -- (2,\i);
										\draw [RoyalBlue] (-1.5,\i-0.5) -- (2.5,\i-0.5);
									}
									\node[ForestGreen] at (0, 3.5) {\Large{$P$}};
									\node[RoyalBlue] at (4, -0.5) {\Large{$U$}};
					
									\node[ForestGreen] at (-2.5, 2) {\normalsize{$i-2$}};
									\node[ForestGreen] at (-2.5, 1) {\normalsize{$i-1$}};
									\node[ForestGreen] at (-2.5, 0) {\normalsize{$i$}};
									\node[ForestGreen] at (-2.5, -1) {\normalsize{$i+1$}};
									\node[ForestGreen] at (-2.5, -2) {\normalsize{$i+2$}};
									\node[ForestGreen] at (2, 2.5) {\normalsize{$j+2$}};
									\node[ForestGreen] at (1, 2.5) {\normalsize{$j+1$}};
									\node[ForestGreen] at (0, 2.5) {\normalsize{$j$}};
									\node[ForestGreen] at (-1,2.5) {\normalsize{$j-1$}};
									\node[ForestGreen] at (-2,2.5) {\normalsize{$j-2$}};
					
									\node[RoyalBlue] at (3, 1.5) {\normalsize{$i-\frac{3}{2}$}};
									\node[RoyalBlue] at (3, 0.5) {\normalsize{$i-\frac{1}{2}$}};
									\node[RoyalBlue] at (3, -0.5) {\normalsize{$i+\frac{1}{2}$}};
									\node[RoyalBlue] at (3, -1.5) {\normalsize{$i+\frac{3}{2}$}};
									\node[RoyalBlue] at (3, -2.5) {\normalsize{$i+\frac{5}{2}$}};
									\node[RoyalBlue] at (2.5, -3) {\normalsize{$j+\frac{5}{2}$}};
									\node[RoyalBlue] at (1.5, -3) {\normalsize{$j+\frac{3}{2}$}};
									\node[RoyalBlue] at (0.5, -3) {\normalsize{$j+\frac{1}{2}$}};
									\node[RoyalBlue] at (-0.5, -3) {\normalsize{$j-\frac{1}{2}$}};
									\node[RoyalBlue] at (-1.5, -3) {\normalsize{$j-\frac{3}{2}$}};
					
									\draw[thick, black, fill=Red] (0,0) circle (0.1);
							\end{tikzpicture}}
			...
			\subsection{Pulsing sphere}
				...
				\begin{frame}{Results}{Pulsing sphere}
					...
					\begin{minipage}[c]{0.4\textwidth}
						\begin{figure}
							\movie{\includegraphics[width=\textwidth]{images/sphere/2dfdtd_00100.png}}{sphere.mp4}
						\end{figure}
					\end{minipage}
					\hfill
